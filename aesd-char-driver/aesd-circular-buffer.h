...
extern int aesd_circular_buffer_find_fpos_for_entry_offset(struct aesd_circular_buffer *buffer, uint32_t buffer_offset, uint32_t entry_offset, uint64_t *fpos);

extern uint64_t aesd_buffer_size(struct aesd_circular_buffer *buffer);
